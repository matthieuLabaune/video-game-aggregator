...
class ViewGameTest extends TestCase
{
    ...
    public function test_the_game_page_show_correct_game_info()
    {
        Http::fake([
        ...
        $response = $this->get(route('games.show', 'twelve-minutes'));

        $response->assertSuccessful();
        $response->assertSee('Twelve Minutes');
        $response->assertSee('Point-and-click');
        $response->assertSee('Luis Antonio');
        $response->assertSee('PC');
        $response->assertSee('PS4');
        $response->assertSee('https://twitter.com/12minutesgame');
        $response->assertSee('https://www.facebook.com/twelveminutesgame');
        $response->assertSee('http://twelveminutesgame.com/');
        $response->assertSee('Rusty Lake Hotel');
    }
