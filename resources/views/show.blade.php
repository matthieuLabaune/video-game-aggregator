...
@section('content')
    <div class="container mx-auto px-4">
        <div class="game details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            <div class="flex-none">
                <img src="ff7.jpg" alt="final fantasy 7 cover">
            </div>
            <div class="lg:ml-12 lg:mr-64 mt-1 lg:mt-0">
                <h2 class="font-semibold text-4xl leading-tight">Final Fantasy 7 Remake</h2>
                ...
                <p class="mt-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci aliquam animi
                    consequatur consequuntur corporis deleniti dolorum error et eveniet facilis id, inventore ipsam
                    itaque iusto, laudantium molestiae nam nostrum obcaecati, odio perferendis qui quis recusandae
                    repellat repudiandae sequi similique temporibus vitae? Doloremque doloribus illum impedit
                    necessitatibus nisi omnis pariatur, sequi.</p>
        ...
        <div class="similar-games-container mt-8">
            <h2 class="text-blue-500 uppercase tracking-wide font-semibold">Similare games</h2>
